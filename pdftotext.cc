...
static ArgDesc argDesc[] = {
  ...
  {"-sep",  argString,      textSeparator,  sizeof(textSeparator),
   "adds separator to help build csv or other separation type"},
...
int main(int argc, char *argv[]) {
  ...
  if (textSeparator[0]) {    
    globalParams->setSeparator(textSeparator);
  }
  ...
  textOut = new TextOutputDev(textFileName->getCString(),
			      physLayout, fixedPitch, rawOrder, htmlMeta, textSeparator);

  printf("\nTEXTOUT\n");
  printf(textFileName->getCString());
